            ...
            <div class="row">
                ...
                <h3>SIGN UP:</h3>
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group"><label>EMAIL-ID: &nbsp;</label><input type="email" class="form-control-sm" placeholder="email-id" name="email" id="email"><br></div>
                        <div class="form-group"><label>CONTACT NO: &nbsp;</label><input type="number" class="form-control-sm" placeholder="contact" name="contact" id="contact"><br></div>
                        <p>SELECT YOUR TEAM:</p>
                        <div class="form-group"><select name="team" id="team">
                                                          <option value="collab">COLLABORATION AND OUTREACH</option>
                                                          <option value="research">RESEARCH</option>
                                                          <option value="marketing">MARKETING</option>
                                                        </select></div>
                        <p>CHOOSE YOUR POSITION: </p>
                     <div> <input type="radio" name="pos" id="core" value="CORE-MEMBER">  <label><b>CORE-MEMBER</b></label>
                       <input type="radio" name="pos" id="board" value="BOARD-MEMBER"> <label><b>BOARD MEMBER</b></label></div>
                        <div class="form-group"><label>UPLOAD YOUR PHOTO: &nbsp;</label><input type="file" class="form-control-sm" name="photo" id="photo"></div>
                        <input type="submit" class="btn btn-success button" value="signup">
                    </form>
                </div>
